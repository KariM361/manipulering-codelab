...
// din kode her
const purpleFiguresbla = document.getElementsByClassName('purpleFigures');
...
let purpleArray = Array.from(purpleFigures);
...
// din kode her
purpleFigures = document.getElementsByClassName('purpleFigures');
purpleArray = Array.from(purpleFigures);

purpleArray.map((element) => {
  element.style.backgroundColor = 'red';

  // Tjek om elementet har mindst ét child-element
...
// Opret et <article> element som container
